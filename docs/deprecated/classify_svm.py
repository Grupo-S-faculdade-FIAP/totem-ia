#!/usr/bin/env python3
"""
Classificação de Imagens - SVM Classifier
Testa o modelo SVM em todas as imagens da pasta /images
"""
...
def main():
    print("\n" + "=" * 70)
    print("🔍 CLASSIFICANDO IMAGENS COM SVM")
    ...
    if not classifier.load_model():
        print("❌ Erro: Modelo não encontrado. Execute 'python svm_classifier.py' primeiro!")
        return
